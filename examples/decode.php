...
$command = function (
    ...
    // $tableRows[] = $formatTableRow($tempFiles[$fileIndex++]);
    ...
    // $tableRows[] = $formatTableRow($tempFiles[1]);
    ...
    $tableRows = \array_map($formatTableRow, $tempFiles);
